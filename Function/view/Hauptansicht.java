...
public class Hauptansicht extends JFrame {
	...
	public JTextField getTxt_ZeitInMinuten() {
		return txt_ZeitInMinuten;
	}
	...
	public JTextField getTxtStunden() {
		return txtStunden;
	}

	public JTextField getTextMinutenUrzeit() {
		return textMinutenUrzeit;
	}

	public JTextField getText_StundeUhrzeit() {
		return text_StundeUhrzeit;
	}

	public JTextField getText_StundenFahrzeit() {
		return text_StundenFahrzeit;
	}
	...
	public void setTxt_ZeitInMinuten(JTextField txt_ZeitInMinuten) {
		this.txt_ZeitInMinuten = txt_ZeitInMinuten;
	}

	public void setTxt_Adresse(JTextField txt_Adresse) {
	...
	public void setTxtStunden(JTextField txtStunden) {
		this.txtStunden = txtStunden;
	}

	public void setTextMinutenUrzeit(JTextField textMinutenUrzeit) {
		this.textMinutenUrzeit = textMinutenUrzeit;
	}

	public void setText_StundeUhrzeit(JTextField text_StundeUhrzeit) {
		this.text_StundeUhrzeit = text_StundeUhrzeit;
	}

	public void setText_StundenFahrzeit(JTextField text_StundenFahrzeit) {
		this.text_StundenFahrzeit = text_StundenFahrzeit;
	}
